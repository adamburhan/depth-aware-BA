...
def run_db(config, data_root, output_dir, vocab_tree_path=None):
    ...
    extraction_options.sift.max_num_features = config.sift.num_features
    extraction_options.use_gpu = config.sift.use_gpu
    matching_options = pycolmap.FeatureMatchingOptions()
    matching_options.num_threads = num_threads
    matching_options.use_gpu = config.sift.use_gpu
